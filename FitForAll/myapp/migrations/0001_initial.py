# Generated by Django 5.0.3 on 2024-04-12 06:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diastolic_bp', models.IntegerField(null=True, verbose_name='Diastolic Blood Pressure')),
                ('systolic_bp', models.IntegerField(null=True, verbose_name='Systolic Blood Pressure')),
                ('fitness_goal', models.CharField(blank=True, max_length=255, verbose_name='Fitness Goal')),
                ('act_levels', models.CharField(blank=True, max_length=255, verbose_name='Activity Levels')),
            ],
        ),
        migrations.CreateModel(
            name='RoomBooking',
