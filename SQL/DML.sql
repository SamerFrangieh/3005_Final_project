...
VALUES 
(1, 'John Doe', 'password123', '{"bmi": 22, "fat_percentage": 15}', 175.5, 70.0, 65.0, 12, 80, 120, 'Lose Weight', '1-3 x times a week'),
(2, 'Alice Johnson', 'password456', '{"bmi": 25, "fat_percentage": 20}', 165.0, 80.0, 70.0, 10, 85, 125, 'Gain Muscle', '1-3 x times a week');
...
INSERT INTO myapp_member (member_id, name, password, health_metrics, height, weight, goal_weight, weeks_to_goal, diastolic_bp, systolic_bp, fitness_goal, act_levels)
VALUES 
(3, 'Alice Johnson', 'password456', '{"bmi": 25, "fat_percentage": 20}', 165.0, 80.0, 70.0, 10, 85, 125, 'Lose weight','1-3 x times a week');
